% CODEX-RS(SECTION) | User Commands
%
% "25 Jun 2026"
...
codex-rs - short summary

# SYNOPSIS

**codex-rs** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**codex-rs** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

**codex-rs** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    codex-rs. See **foo.conf**(5) for further details.
...
**codex-rs** provides some return codes, that can be used in scripts:
...
Matthew Cramer <mcramer@localhost>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2026 Matthew Cramer
